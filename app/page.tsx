...
import { Search, Cpu, ShieldAlert, Award, FileSpreadsheet } from 'lucide-react';
        ...
        <div className="container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: 'var(--space-6)', position: 'relative' }}>
          ...
          <div 
            ...
            style={{
              ...
              fontWeight: 600,
              color: 'var(--cyan)',
              backgroundColor: 'hsla(192, 100%, 55%, 0.08)',
              border: '1px solid hsla(192, 100%, 55%, 0.25)',
              display: 'inline-flex',
              alignItems: 'center',
              gap: '6px',
              boxShadow: '0 0 20px hsla(192,100%,55%,0.08)'
            }}
          >
            <ShieldAlert size={14} />
          ...
          <div style={{ maxWidth: '800px', display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
            <h1 className="hero-headline" style={{
              ...
              How Effective Is AI On Your Codebase?
            </h1>
            <p style={{ fontSize: 'var(--text-xl)', color: 'var(--text-secondary)', fontWeight: 400, maxWidth: '600px', margin: '0 auto', lineHeight: 1.5 }}>
          ...
          <div style={{ width: '100%', maxWidth: '640px', marginTop: 'var(--space-3)' }}>
          ...
          >
            <div className="glass" style={{ padding: 'var(--space-4) var(--space-5)', textAlign: 'left', borderLeft: '2px solid var(--danger)' }}>
              ...
              <p style={{ fontSize: 'var(--text-xs)', color: 'var(--text-secondary)', marginTop: '4px', lineHeight: 1.4 }}>
                More technical issues introduced by AI coding without repository context context synchronization.
              </p>
            </div>
            <div className="glass" style={{ padding: 'var(--space-4) var(--space-5)', textAlign: 'left', borderLeft: '2px solid var(--warning)' }}>
            ...
            <div className="glass" style={{ padding: 'var(--space-4) var(--space-5)', textAlign: 'left', borderLeft: '2px solid var(--cyan)' }}>
          ...
          <div style={{ marginTop: 'var(--space-8)', width: '100%', maxWidth: '960px' }}>
            <h2 style={{ fontSize: 'var(--text-xl)', color: 'white', fontWeight: 800, marginBottom: 'var(--space-6)' }}>
            ...
            >
              <div className="glass" style={{ padding: 'var(--space-5)', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: 'hsla(192, 100%, 55%, 0.1)', border: '1px solid hsla(192, 100%, 55%, 0.3)', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', color: 'var(--cyan)' }}>
                  <Award size={20} />
                </div>
              ...
              <div className="glass" style={{ padding: 'var(--space-5)', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: 'hsla(265, 90%, 65%, 0.1)', border: '1px solid hsla(265, 90%, 65%, 0.3)', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', color: 'var(--purple)' }}>
                  <Cpu size={20} />
                </div>
              ...
              <div className="glass" style={{ padding: 'var(--space-5)', textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: 'hsla(145, 75%, 48%, 0.1)', border: '1px solid hsla(145, 75%, 48%, 0.3)', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', color: 'var(--success)' }}>
